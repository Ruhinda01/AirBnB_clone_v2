#!/usr/bin/python3
"""
This module displays a HTML page only if n is an int
...
def number_template(n):
    """
    Route /number_template/<n> displays HTML page
    only if n is an int
    """
...
def number_odd_or_even(n):
    """
    Checks if n is even or odd and then displays
    a HTML page only if n is an int
    """
    if n % 2 == 0:
        return render_template('6-number_odd_or_even.html', n=n, even="even")
    else:
        return render_template('6-number_odd_or_even.html', n=n, even=None)
